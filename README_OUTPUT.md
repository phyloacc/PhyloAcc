...
*prefix*\_rate_postZ\_\*.txt: posterior median of conserved rate, accelerated rate, probability of gain and loss conservation ($P(Z=0\rightarrow Z=1)$ and $P(Z=1\rightarrow Z=2)$), and posterior mean of latent state on each branch for each element. Columns in the file are:
