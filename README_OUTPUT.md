...
*prefix*\_rate_postZ\_\*.txt: posterior median of conserved rate, accelerated rate, probability of gain and loss conservation ($P(Z=0\rightarrow Z=1)$ and $P(Z=1\rightarrow Z=2)$), and posterior mean of the probability of being in each latent state on each branch for each element. Columns in the file are:
...
4. posterior median of $P(Z=0\rightarrow Z=1)$
5. posterior median of $P(Z=1\rightarrow Z=2)$
6. posterior median of $P(Z=0\rightarrow Z=2)$, which is 0 in current implementation
