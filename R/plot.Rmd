...
tit = paste("logBF1:", round(lk$log_ratio), "logBF2:",round(lk$BF2), "  ") # use BF scores and posterior substitution rates as title
plotZPost(Z, treeData, target_species=targets, tit=tit, offset=6,cex.score = 2) # offset= 6 indicates the posterior of Z start from 7th column
```
