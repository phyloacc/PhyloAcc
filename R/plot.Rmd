...
score <- read.table("../Simulation_ratite/result/simu_500_200_2-6_elem_lik.txt", header=T)
## compute BF2
...
postZ <- read.table("../Simulation_ratite/result/simu_500_200_2-6_rate_postZ_1.txt", header=T, check.names = F)  ## _1 is the posteriors under full model
```
...
plotZPost(Z, treeData, target_species=targets, tit=tit, offset=3) # offset= 3 indicates the posterior of Z start from 4th column
```
