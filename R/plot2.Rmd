...
```{r treeData, cache=F}
treeData <- prepare_data(tree_path = "../Data/neut_ver3_final.named.mod2", species_name = "../Data/result/longcneeseqs_species_names.txt", common_name = "../Data/birdname2.txt")
```
...
score <- read.table("../Data/result/longcneeseqs_nocore_elem_lik.txt", header=T)
## compute BF2
...
postZ <- read.table("../Data/result/longcneeseqs_nocore_rate_postZ_1.txt", header=T, check.names = F)  ## _1 is the posteriors under full model
```
...
#pdf("longcneeseqs_post_tree.pdf")
...
bed <- read.delim("../Data/longcneeseqs_trimmed_aligned_nocore.bed", header=F)
fasta <- read.alignment(file = "../Data/longcneeseqs_trimmed_aligned_nocore.fas", format = "fasta")  
